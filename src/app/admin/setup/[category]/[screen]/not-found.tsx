  ...
  return (
    <div className="flex min-w-0 flex-1 flex-col">
      ...
      <div className="flex min-w-0 flex-col items-center rounded-xl border border-border bg-surface px-6 py-16 text-center shadow-sm sm:px-12">
        <h1 className="text-xl font-semibold text-text-primary">{t("setup.notFound.title")}</h1>
        <p className="mt-2 max-w-md text-sm text-text-muted">{t("setup.notFound.message")}</p>
      </div>
    </div>
  );
}
