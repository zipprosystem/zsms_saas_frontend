...
/**
 * Reserved namespace for the future parent panel (<slug>.zsmsapp.com/parent/*).
 * Not designed or built yet — see the panel-router comment in src/app/page.tsx.
 * Intentionally has no shared layout: the parent panel will get its own
  ...
  return (
    <div className="flex h-dvh items-center justify-center bg-background p-8">
      <p className="text-lg font-medium text-text-primary">
        {t("panels.parent.title")} — {t("common.comingSoon")}
      </p>
    </div>
  );
}
